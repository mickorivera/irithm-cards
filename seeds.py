...
def seed():
    ...
    angelo = UserModel.create(
        username="angelo", email_address="angelo@gmail.com", password="qwerty"
    )
    logging.info(f"Created {angelo.username}")

    rivera = UserModel.create(
        username="rivera", email_address="rivera@gmail.com", password="qwerty"
    )
            ...
            for card_index in range(3):
                ...
                for comment_index in range(5):
                    ...
                    for reply_index in range(5):
                        comment_reply = CommentReplyModel.createg(
                            author=admin,
                            comment=comment,
